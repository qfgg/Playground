  ...
  function build() {
    ...
    svg.ajax = function(url) {
      ...
      if (window.XMLHttpRequest) {
        ...
        AJAX = new ActiveXObject('Microsoft.XMLHTTP'); // eslint-disable-line no-undef
      }
      if (AJAX) {
    ...
    svg.Element.RenderedElementBase = function(node) {
      ...
      this.setContext = function(ctx) {
        ...
        if (this.style('fill').isUrlDefinition()) {
          fs = this.style('fill').getFillStyleDefinition(this);
        ...
        if (this.style('stroke').isUrlDefinition()) {
          fs = this.style('stroke').getFillStyleDefinition(this);
    ...
    svg.Element.pattern = function(node) {
      ...
      this.createPattern = function(ctx) {
    ...
    svg.Element.image = function(node) {
      ...
      if (!isSvg) {
        ...
        this.img.onerror = function() {
          if (console) console.log('ERROR: image "' + href + '" not found'); // eslint-disable-line no-console
          self.loaded = true;
        };
        this.img.src = href;
      } else {
    ...
    svg.Element.MISSING = function(node) {
      if (console) console.log('ERROR: Element \'' + node.nodeName + '\' not yet implemented.'); // eslint-disable-line no-console
    };
