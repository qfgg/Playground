...
import {
  ...
  HEADER,
  FIELD,
} from '../../../constants/Reports/RoutingAsymmetryAS/RoutingAsyASTypes';
import './index.less';


export default class RoutingAsyAS extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activePeriod: 'Today',
        ...
        <div className="routing-wrap">
          ...
          <Dropdown isOpen={isOpen} curSelect={subNav}>
            ...
            <li className="option" onClick={() => this.handleClick('Prefix')}>
              <Link to="/reports/routingAsymmetryPrefix">Prefix</Link>
            </li>
          </Dropdown>
          <OptionBtn
