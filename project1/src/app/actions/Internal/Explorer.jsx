...
export const removeALLSelItem = type => ({
  type: types.REMOVE_ALL_SEL_ITEM,
  payload: type
});
...
export const setARouterFlag = isSelected => ({
  type: types.SET_A_ROUTER_SEL,
  payload: isSelected
});

export const setBRouterFlag = isSelected => ({
  type: types.SET_B_ROUTER_SEL,
  payload: isSelected
});
